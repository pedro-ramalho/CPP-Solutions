...
int main() {
    ...
    cout << "Enter a month and a year (MM/YY): " << endl;
    cin >> month >> separator >> year; //asking the user to input a month and a year

    if (separator != '/')
        cerr << "Invalid separator!" << endl;

    if (month < 1 || month > 12)
        cerr << "Invalid month input! Please, input a correct month, from 1 to 12." << endl;
